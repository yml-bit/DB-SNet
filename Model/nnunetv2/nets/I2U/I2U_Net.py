...
class I2U_Net_M(nn.Module):
    def __init__(self, classes=4, channels=3):
        ...
        self.finaldeconv11 = nn.ConvTranspose2d(32, 32, 4, 2, 1)
        self.finalrelu11 = nonlinearity
        self.finalconv33 = nn.Conv2d(32, classes, 3, padding=1)
    ...
    def forward(self, x):
        ...
        outt = self.finaldeconv11(dh_0)
        outt = self.finalrelu11(outt)
        outt = self.finalconv33(outt)
        return out,outt
