...
class DBBasicUNet(nn.Module):
    def __init__(
        ...
        self.upcat_44 = UpCat(spatial_dims, fea[4], fea[3], fea[3], act, norm, bias, dropout, upsample)
        self.upcat_33 = UpCat(spatial_dims, fea[3], fea[2], fea[2], act, norm, bias, dropout, upsample)
        self.upcat_22 = UpCat(spatial_dims, fea[2], fea[1], fea[1], act, norm, bias, dropout, upsample)
        self.upcat_11 = UpCat(spatial_dims, fea[1], fea[0], fea[5], act, norm, bias, dropout, upsample, halves=False)

        self.final_convv = Conv["conv", spatial_dims](fea[5], out_channels, kernel_size=1)
    ...
    def forward(self, x: torch.Tensor):
        ...
        logits1 = self.final_conv(u1)

        u44 = self.upcat_44(x4, x3)
        u33 = self.upcat_33(u44, x2)
        u22 = self.upcat_22(u33, x1)
        u11 = self.upcat_11(u22, x0)
        logits2 = self.final_convv(u11)
...
if  __name__=='__main__':
    ...
    # b=1
    model = DBBasicUNet(3,1,4,(32, 32, 64, 128, 256, 32))
