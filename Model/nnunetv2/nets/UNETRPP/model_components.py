...
class UnetrPPEncoder(nn.Module):
    def __init__(self, input_size=[64*64*64,32 * 32 * 32, 16 * 16 * 16, 8 * 8 * 8],dims=[32, 64, 128, 256],
        ...
        stem_layer = nn.Sequential(
            get_conv_layer(spatial_dims, in_channels, dims[0], kernel_size=(4, 4, 4), stride=(2, 2, 2),# kernel_size=(4, 4, 4), stride=(2, 2, 2)
