from nnunetv2.nets.MTSNet.MTSMed import MedNeXt1#原始
...
class nnUNetTrainerMednext1(nnUNetTrainer):
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = MedNeXt1(in_channels=num_input_channels, n_channels=32,  # 增大通道，减少卷积核l3
