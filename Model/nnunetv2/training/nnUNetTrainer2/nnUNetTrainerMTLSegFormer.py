from nnunetv2.nets.MTLSegFormer.prepare_networks import MTLSegFormer #原始
...
class nnUNetTrainerMTLSegFormer(nnUNetTrainerNoDeepSupervision):
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        Out_channel=label_manager.num_segmentation_heads
        model = MTLSegFormer(num_classes_per_task=[Out_channel, Out_channel], num_tasks=2)
        return model
