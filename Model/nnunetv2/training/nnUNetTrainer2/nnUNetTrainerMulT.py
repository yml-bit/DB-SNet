from nnunetv2.nets.MulT.prepare_networks import MulT #原始
...
class nnUNetTrainerMulT(nnUNetTrainerNoDeepSupervision):
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        tasks_config = {
            'sem_seg1': {'type': 'segmentation1', 'num_classes': label_manager.num_segmentation_heads},
            'sem_seg2': {'type': 'segmentation2', 'num_classes': label_manager.num_segmentation_heads}
            # 其他任务...
        }
        model = MulT(
        ...
        # model=MulT(in_channels=1,channels=[32, 64, 128, 256],num_classes=label_manager.num_segmentation_heads)
        return model
