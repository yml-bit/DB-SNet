from nnunetv2.nets.MTSNet.MTSNet import DBSNet3 #原始
...
class nnUNetTrainerDSNet3(nnUNetTrainer):#nnUNetTrainer
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = DBSNet3(in_channels=num_input_channels, n_channels=32,  # 增大通道，减少卷积核l3
