from nnunetv2.nets.I2U.I2U_Net import I2U_Net_M #原始
...
class nnUNetTrainerI2UNet(nnUNetTrainerNoDeepSupervision):
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = I2U_Net_M(classes=label_manager.num_segmentation_heads)
        return model
