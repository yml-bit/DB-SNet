from nnunetv2.nets.DBUNet.prepare_networks import DBBasicUNet #原始
...
class nnUNetTrainerDBUNet(nnUNetTrainerNoDeepSupervision):
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = DBBasicUNet(in_channels=num_input_channels,out_channels=label_manager.num_segmentation_heads)
        return model
