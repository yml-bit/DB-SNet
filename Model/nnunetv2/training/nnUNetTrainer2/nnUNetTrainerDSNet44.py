from nnunetv2.nets.MTSNet.MTSNet import DBSNet44 #原始
...
class nnUNetTrainerDSNet44(nnUNetTrainer): #nnUNetTrainer nnUNetTrainerNoDeepSupervision
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = DBSNet44(in_channels=num_input_channels, n_channels=32,  # 增大通道，减少卷积核l3
