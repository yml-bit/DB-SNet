from nnunetv2.nets.MTSNet.MTSNet import DBSNet6 #原始
...
class nnUNetTrainerDSNet6666(nnUNetTrainer): #nnUNetTrainer nnUNetTrainerNoDeepSupervision
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = DBSNet6(in_channels=num_input_channels, n_channels=32,  # 增大通道，减少卷积核l3
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
            ...
            # del data
            l =  0.4 *self.loss(output[0], target_task1) +  0.6 *self.loss(output[1], target_task2)
