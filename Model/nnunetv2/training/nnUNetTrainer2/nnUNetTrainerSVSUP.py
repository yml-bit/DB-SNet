from nnunetv2.nets.SVSUP.SVSUP_network import SVSUP #原始
...
class nnUNetTrainerSVSUP(nnUNetTrainerNoDeepSupervision):
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = SVSUP(in_channels=num_input_channels,out_channels=label_manager.num_segmentation_heads)
        return model
