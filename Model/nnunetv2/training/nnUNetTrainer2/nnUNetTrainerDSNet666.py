...
class nnUNetTrainerDSNet666(nnUNetTrainer): #nnUNetTrainer nnUNetTrainerNoDeepSupervision
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        with autocast(self.device.type, enabled=True) if self.device.type == 'cuda' else dummy_context():
            ...
            # del data
            l =  0.7 *self.loss(output[0], target_task1) +  0.3 *self.loss(output[1], target_task2)
