from nnunetv2.nets.MTFormer.prepare_networks import MTFormer #原始
...
class nnUNetTrainerMTFormer(nnUNetTrainerNoDeepSupervision):
    def __init__(
            self,
            plans: dict,
            configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = MTFormer(1, label_manager.num_segmentation_heads)
        return model
