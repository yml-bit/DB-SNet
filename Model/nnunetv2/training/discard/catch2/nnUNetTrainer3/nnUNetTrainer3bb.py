...
class nnUNetTrainer(object):
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        if self.grad_scaler is not None:
            self.grad_scaler.scale(l2).backward(retain_graph=True)
    ...
    def validation_step(self, batch: dict) -> dict:
        ...
        if self.enable_deep_supervision:
            ...
            output2 = output[1][0]  ######需要修改
            target2 = target_task2[1]
        ...
        tp, fp, fn, _ = get_tp_fp_fn_tn(predicted_segmentation_onehot2, target2, axes=axes, mask=mask2)
        ...
        return {'loss2': l2.detach().cpu().numpy(), 'tp_hard': tp_hard, 'fp_hard': fp_hard, 'fn_hard': fn_hard}
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        global_dc_per_class,loss_here=self.validation_caculate(tp,fp,fn,loss2)
    ...
    def perform_actual_validation(self, save_probabilities: bool = False):
        ...
        with multiprocessing.get_context("spawn").Pool(default_num_processes) as segmentation_export_pool:
            ...
            for k in dataset_val.keys():
                proceed = not check_workers_alive_and_busy(segmentation_export_pool, worker_list, results2,
                ...
                try:
                    _,prediction2 = predictor.predict_sliding_window_return_logits(data)
                except RuntimeError:
