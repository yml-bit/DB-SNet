...
class nnUNetTrainer(object):
    ...
    def train_step(self, batch: dict) -> dict:
        ...
        if self.grad_scaler is not None:
            ...
            self.grad_scaler.unscale_(self.optimizer_common)
            torch.nn.utils.clip_grad_norm_(self.optimizer_common.param_groups[0]['params'], 12)
            self.grad_scaler.step(self.optimizer_common)
