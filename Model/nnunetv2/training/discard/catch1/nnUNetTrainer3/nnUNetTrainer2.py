...
class nnUNetTrainer(object):
    ...
    def validation_step(self, batch: dict) -> dict:
        ...
        axes = [0] + list(range(2, output2.ndim))
        ...
        return {'loss2': l2.detach().cpu().numpy(), 'tp_hard2': tp_hard2, 'fp_hard2': fp_hard2, 'fn_hard2': fn_hard2}
    ...
    def on_validation_epoch_end(self, val_outputs: List[dict]):
        ...
        global_dc_per_class,loss_here=self.validation_caculate(tp2,fp2,fn2,loss2)
