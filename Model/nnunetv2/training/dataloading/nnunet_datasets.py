...
if __name__ == '__main__':
    ...
    ds = nnUNetDatasets(folder, num_images_properties_loading_threshold=0) # this should not load the properties!
    ...
    # this should have the properties
    ds = nnUNetDatasets(folder, num_images_properties_loading_threshold=1000)
    ...
    ds = nnUNetDatasets(folder, num_images_properties_loading_threshold=0)
    # now rename the properties file so that it does not exist anymore
    shutil.move(join(folder, 'liver_0.pkl'), join(folder, 'liver_XXX.pkl'))
