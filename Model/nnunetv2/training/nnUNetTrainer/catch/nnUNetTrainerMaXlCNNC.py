from nnunetv2.nets.MaXlCNN.MaXlCNNC import MaXlCNNC#原始
...
class nnUNetTrainerMaXlCNNC(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = MaXlCNNC(in_channels=num_input_channels, n_channels=48,  # 增大通道，减少卷积核l3
