from nnunetv2.nets.MaXlCNN.MaXlCNNV1 import MaXlCNN#原始
# from nnunetv2.nets.MaXlCNN.MaXlCNNV2 import MaXlCNN#原始
...
class nnUNetTrainerMaXlCNN(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = MaXlCNN(in_channels=num_input_channels, n_channels=48,  # 增大通道，减少卷积核l3
