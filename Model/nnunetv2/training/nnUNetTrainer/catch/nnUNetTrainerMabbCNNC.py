from nnunetv2.nets.MaXlCNN.MabCNNC import MabCNNC#原始
...
class nnUNetTrainerMabbCNNC(nnUNetTrainer):
    @staticmethod
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = MabCNNC(in_channels=num_input_channels, n_channels=48,  # 增大通道，减少卷积核l3
