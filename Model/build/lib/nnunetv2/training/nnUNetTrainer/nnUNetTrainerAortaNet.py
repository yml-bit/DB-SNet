...
from nnunetv2.nets.AortaNet.AortaV1 import Aorta#match p2-Aorta2
from monai.transforms import AsDiscrete
# from .corrector.reg import Reg3D,Transformer_3D
# from .corrector.losses import * #SSIM3D


class nnUNetTrainerAortaNet(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = Aorta(in_channels=1,n_channels=48,
            n_classes=5,exp_r=[2,3,4,4,4,4,4,3,2],#casecated segmentation network
            kernel_size=3,deep_supervision=False,do_res=True,
            do_res_up_down=True,block_counts=[3, 4, 8, 8, 8, 8, 8, 4, 3],
