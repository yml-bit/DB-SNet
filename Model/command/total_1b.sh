...
#################################### inference##############################################
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainerMednext
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainerUNETRPP
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainerUNETR
...
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainerSegMamba
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainer
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainerUxLSTMBot
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainerUXnet
python ./nnunetv2/inference/predict_from_raw_data_1b.py 0 nnUNetTrainerSegResNet
