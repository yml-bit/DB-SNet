...
def taob_seg():
    ...
    models=["nnUNetTrainerMednext"]
    # models=["nnUNetTrainerUNETRPP", "nnUNetTrainerSwinUNETR","nnUNetTrainerSegResNet",
...
def tab_seg():
    args=config() #the first running should excute this code
    os.environ["CUDA_VISIBLE_DEVICES"] = args.gpu
    # models = [ "nnUNetTrainerMulT","nnUNetTrainerDSNet6f","nnUNetTrainerDSNet66","nnUNetTrainerDSNet666"]  #
    models = [ "nnUNetTrainerDSNet6r"]  #
    # models = ["nnUNetTrainerDSNetG", "nnUNetTrainerDSNet555", "nnUNetTrainerDSNet44", "nnUNetTrainerDSNetF"]  #
    # models = ["nnUNetTrainerMTFormer", "nnUNetTrainerMTLSegFormer"]
    # models=["nnUNetTrainerDSNet6","nnUNetTrainerI2UNet","nnUNetTrainerDBUNet" ]#
    # models=["nnUNetTrainerDSNet4","nnUNetTrainerDSNet0","nnUNetTrainerDSNet3","nnUNetTrainerDSNet1"]#
    # models=["nnUNetTrainerMednext0a","nnUNetTrainerMednext12","nnUNetTrainerMednext0","nnUNetTrainerMednext13"，"nnUNetTrainerMednext3b"
    # ,"nnUNetTrainerMednext4b","nnUNetTrainerMednext3","nnUNetTrainerDNet"]
...
def mab_seg():
    ...
    # models=["nnUNetTrainerDSNet6","nnUNetTrainerI2UNet","nnUNetTrainerDBUNet"]#
    # models=["nnUNetTrainerDSNet4","nnUNetTrainerDSNet0","nnUNetTrainerDSNet3","nnUNetTrainerDSNet1"]#
    # models = ["nnUNetTrainerMednext0a","nnUNetTrainerMednext12", "nnUNetTrainerMednext0",
    # "nnUNetTrainerMednext13"，"nnUNetTrainerMednext3b","nnUNetTrainerMednext3","nnUNetTrainerDNet"]
    file_p = "./seg_ab/"
    os.makedirs(file_p, exist_ok=True)
    flags = [1, 2]  # task1
    for flag in flags:
